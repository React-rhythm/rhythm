...
class Change extends Component{
    ...
    handleGetCodeClick = async() => {
        const findPhoneRes = await http.get(`http://114.67.247.63:8010/userInfo/register/resetPwd/${this.props.phoneid}`)
    ...
    handleResetPhone = async() => {
        ...
        const result = await http.post('http://114.67.247.63:8010/userInfo/phoneUpdate',JSON.stringify(obj))
        console.log(result)
    }
